...
import com.example.agrimanagementapp.navigation.SECOND_URL
...
fun AboutScreen(navController: NavHostController) {
    Box(modifier = Modifier.fillMaxSize(),contentAlignment = Alignment.Center) {
        ...
        Column(
            ...
            Text(
                text = " Agri Management App is an easy to use app designed to connect sellers and buyers of agricultural produce. ",
                fontSize = 25.sp,
